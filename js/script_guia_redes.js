...
const CLOUD_REFRESH_REDES = 300000;
...
<div class="word-logo-line">
  <img src="${escapeHtml(getSenaLogoUrlRedes())}" alt="Logo SENA" width="36" height="36" style="width:36pt;height:36pt;">
...
(function installRedesDeadlineWrappers() {
  const uiConfigs = {
    ...
    ip1: { lockKey: "ip1-locked", fieldSelector: "[data-store^='ip1-']", extraDisableSelector: "#ip1ImagenLabel", extraDisableIds: ["ip1ImagenInput"], buttonId: "btnGuardarIP1", statusId: "ip1Status", activeButtonText: "Guardar respuestas", lockedButtonText: "Respuestas guardadas", closedButtonText: "Entrega cerrada", adminMount: { mountSelector: "#ip1DeadlineControls" }, noticeMount: { mountSelector: "#ip1DeadlineControls" } },
    ip3: { lockKey: "ip3-locked", fieldSelector: "[data-store^='ip3-']", extraDisableSelector: "#ip3ImagenLabel", extraDisableIds: ["ip3ImagenInput"], buttonId: "btnGuardarIP3", statusId: "ip3Status", activeButtonText: "Guardar respuestas", lockedButtonText: "Respuestas guardadas", closedButtonText: "Entrega cerrada", adminMount: { mountSelector: "#ip3DeadlineControls" }, noticeMount: { mountSelector: "#ip3DeadlineControls" } },
    "taller-ip-ej1": { lockKey: "taller-ip-ej1-locked", fieldSelector: "[data-store^='ej1-']", buttonId: "btnGuardarTallerIPEj1", statusId: "tallerIPEj1Status", activeButtonText: "Guardar respuestas", lockedButtonText: "Respuestas guardadas", closedButtonText: "Entrega cerrada", adminMount: { mountSelector: "#tallerIPEj1DeadlineControls" }, noticeMount: { mountSelector: "#tallerIPEj1DeadlineControls" } },
    "taller-ip-ej2": { lockKey: "taller-ip-ej2-locked", fieldSelector: "[data-store^='ej2-']", buttonId: "btnGuardarTallerIPEj2", statusId: "tallerIPEj2Status", activeButtonText: "Guardar respuestas", lockedButtonText: "Respuestas guardadas", closedButtonText: "Entrega cerrada", adminMount: { mountSelector: "#tallerIPEj2DeadlineControls" }, noticeMount: { mountSelector: "#tallerIPEj2DeadlineControls" } },
    "taller-ip-ej3": { lockKey: "taller-ip-ej3-locked", fieldSelector: "[data-store^='ej3-']", buttonId: "btnGuardarTallerIPEj3", statusId: "tallerIPEj3Status", activeButtonText: "Guardar respuestas", lockedButtonText: "Respuestas guardadas", closedButtonText: "Entrega cerrada", adminMount: { mountSelector: "#tallerIPEj3DeadlineControls" }, noticeMount: { mountSelector: "#tallerIPEj3DeadlineControls" } },
    "taller-ip-ej4": { lockKey: "taller-ip-ej4-locked", fieldSelector: "[data-store^='ej4-']", extraDisableIds: ["ej4CapturaInput", "btnSubirTallerIPEj4"], buttonId: "btnGuardarTallerIPEj4", statusId: "tallerIPEj4Status", activeButtonText: "Guardar respuestas", lockedButtonText: "Respuestas guardadas", closedButtonText: "Entrega cerrada", adminMount: { mountSelector: "#tallerIPEj4DeadlineControls" }, noticeMount: { mountSelector: "#tallerIPEj4DeadlineControls" } },
    "taller-ip-ej5": { lockKey: "taller-ip-ej5-locked", fieldSelector: "[data-store^='ej5-']", buttonId: "btnGuardarTallerIPEj5", statusId: "tallerIPEj5Status", activeButtonText: "Guardar respuestas", lockedButtonText: "Respuestas guardadas", closedButtonText: "Entrega cerrada", adminMount: { mountSelector: "#tallerIPEj5DeadlineControls" }, noticeMount: { mountSelector: "#tallerIPEj5DeadlineControls" } },
    lab1: { lockKey: "lab1-locked", fieldSelector: "[data-store^='lab1-']", extraDisableIds: ["lab1Ping1Input", "lab1Ping2Input", "lab1BroadcastInput", "lab1IpconfigInput", "btnSubirLab1Ping1", "btnSubirLab1Ping2", "btnSubirLab1Broadcast", "btnSubirLab1Ipconfig"], buttonId: "btnGuardarLab1", statusId: "lab1Status", activeButtonText: "Guardar respuestas del laboratorio", lockedButtonText: "Respuestas guardadas", closedButtonText: "Entrega cerrada", adminMount: { mountSelector: "#lab1DeadlineControls" }, noticeMount: { mountSelector: "#lab1DeadlineControls" } },
    lab2: { lockKey: "lab2-locked", fieldSelector: "[data-store^='lab2-']", extraDisableIds: ["lab2PingMismoInput", "lab2PingDifInput", "lab2TracertInternoInput", "lab2TracertExternoInput", "btnSubirLab2PingMismo", "btnSubirLab2PingDif", "btnSubirLab2TracertInterno", "btnSubirLab2TracertExterno"], buttonId: "btnGuardarLab2", statusId: "lab2Status", activeButtonText: "Guardar respuestas del laboratorio", lockedButtonText: "Respuestas guardadas", closedButtonText: "Entrega cerrada", adminMount: { mountSelector: "#lab2DeadlineControls" }, noticeMount: { mountSelector: "#lab2DeadlineControls" } },
    lab3: { lockKey: "lab3-locked", fieldSelector: "[data-store^='lab3-']", extraDisableIds: ["lab3TopologiaInput", "lab3PingBloquesInput", "lab3PingWifiInput", "lab3IpconfigWifiInput", "btnSubirLab3Topologia", "btnSubirLab3PingBloques", "btnSubirLab3PingWifi", "btnSubirLab3IpconfigWifi"], buttonId: "btnGuardarLab3", statusId: "lab3Status", activeButtonText: "Guardar respuestas del laboratorio", lockedButtonText: "Respuestas guardadas", closedButtonText: "Entrega cerrada", adminMount: { mountSelector: "#lab3DeadlineControls" }, noticeMount: { mountSelector: "#lab3DeadlineControls" } },
    social: { lockKey: "social-locked", fieldSelector: "[data-store^='social-']", extraDisableSelector: "#socialImagenLabel", extraDisableIds: ["socialImagenInput"], buttonId: "btnGuardarSocial", statusId: "socialStatus", activeButtonText: "Guardar respuestas", lockedButtonText: "Respuestas guardadas", closedButtonText: "Entrega cerrada", adminMount: { mountSelector: "#socialDeadlineControls" }, noticeMount: { mountSelector: "#socialDeadlineControls" } },
  };
...
(function mountAvancePanelGuiaRedes() {
  function render() {

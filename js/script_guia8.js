// script_guia8.js — Guia 8: Documentar la gestion de la informacion (RAP 04)
...
(function () {
  ...
  const PAGE_KEY = GUIDE_DATA_FILE.replace(/[^a-z0-9]+/g, "_") || "guia8";
  ...
  async function flushCloudSync() {
    ...
    try {
      ...
      console.warn("[guia8] cloud sync failed", err);
    }
  }
  ...
  const FORM_FIELDS = [
    "g8_411_datos", "g8_411_consecuencias", "g8_411_experiencia", "g8_411_documento",
    "g8_412_comunes", "g8_412_documento_urgente", "g8_412_reflexion",
    "g8_421_reparto", "g8_421_temas", "g8_421_documento", "g8_421_paraque", "g8_421_ejemplo", "g8_421_aporte", "g8_421_dudas",
    "g8_422_central", "g8_422_relacion", "g8_422_protocolo", "g8_422_aplicacion",
    "g8_431_ficha_tecnica", "g8_431_hoja_vida", "g8_431_inventario", "g8_431_backup", "g8_431_chequeo", "g8_431_procedimientos", "g8_431_conclusion",
    "g8_432_estructura", "g8_432_convencion", "g8_432_versiones", "g8_432_protocolo",
  ...
  function initGuia8() {
    ...
    updateProgress();
    reflectGradesForGuia8();
  }

  // Guia 8 nunca llamaba a reflectGradesIntoGuideState (mismo bug que Guia 5 y
  // Guia 7, ver reflectGradesForGuia5() en js/script.js): si el admin aprobaba
  ...
  // de pruebas 11A.
  function reflectGradesForGuia8() {
    ...
    mgr.reflectGradesIntoGuideState({
      guideFamily: "guia-08-documentar-gestion",
      pageFile: PAGE_FILE,
  ...
  window.initGuia8 = initGuia8;

  if (!window.__PAGE_CONTEXT__) {
    document.addEventListener("DOMContentLoaded", initGuia8);
  }

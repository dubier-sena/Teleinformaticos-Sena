...
const EXPECTED_VARIANTS = {
  "redes-rap01-quiz-10a": {
    ...
    outputFile: "santa-barbara-10a-guia-02-redes-rap01-quiz.html",
    grupo: "10A",
    ficha: "3441944",
  ...
  "redes-rap01-quiz-10b": {
    template: "redes-rap01-quiz.template.html",
    outputFile: "santa-barbara-10b-guia-02-redes-rap01-quiz.html",
    grupo: "10B",
    ficha: "3441950",
    inst: "Institucion Educativa Santa Barbara",
  ...
  "redes-ip-quiz-10a": {
    ...
    outputFile: "santa-barbara-10a-guia-02-redes-ip-quiz.html",
    grupo: "10A",
    ficha: "3441944",
    inst: "Institucion Educativa Santa Barbara",
  ...
  "redes-ip-quiz-10b": {
    template: "redes-ip-quiz.template.html",
    outputFile: "santa-barbara-10b-guia-02-redes-ip-quiz.html",
    grupo: "10B",
    ficha: "3441950",
    inst: "Institucion Educativa Santa Barbara",
  ...
  "guia2-matriz-322-10a": {
    ...
    outputFile: "grupo-10a-guia-02-actividad-322-matriz.html",
    grupo: "10A",
    ficha: "3441939",
  ...
  "guia2-matriz-322-10b": {
    template: "guia-02-matriz-322.template.html",
    outputFile: "grupo-10b-guia-02-actividad-322-matriz.html",
    grupo: "10B",
    ficha: "3441942",
    inst: "Institucion Educativa Jhon F. Kennedy",

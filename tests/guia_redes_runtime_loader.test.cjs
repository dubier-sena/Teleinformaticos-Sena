...
test("runtime loader injects the shared guide and boots both init hooks in order", async () => {
  ...
  assert.equal(harness.quizRedesLink.href, "pages/auxiliares/santa-barbara-10a-guia-02-redes-rap01-quiz.html");
  assert.equal(harness.quizIpLink.href, "pages/auxiliares/santa-barbara-10a-guia-02-redes-ip-quiz.html");

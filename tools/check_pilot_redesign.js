...
const portalChecks = [
  {
    pattern: /href="css\/site_tokens\.css\?v=\d{8}_\d+"/,
    message: "Portal missing shared token import.",
  },
  {
    pattern: /href="css\/shared_shell\.css\?v=\d{8}_\d+"/,
    message: "Portal missing shared shell stylesheet import.",
  },
  {
    pattern: /href="css\/page_portal\.css\?v=\d{8}_\d+"/,
    message: "Portal missing portal page stylesheet import.",
  },
  {
    pattern: /<script[^>]*defer[^>]*src="js\/shared_shell\.js\?v=\d{8}_\d+"/i,
  ...
  {
    pattern: /class="[^"]*\bportal-hero\b[^"]*"/i,
    message: "Portal is missing the portal-hero wrapper.",
  },
  {
    pattern: /class="[^"]*\bportal-hero__title\b[^"]*"/i,
    message: "Portal is missing the portal-hero title markup.",
  },
  {
  ...
  {
    pattern: /class="[^"]*\bportal-col--auth\b[^"]*"/i,
    message: "Portal is missing the auth column wrapper.",
  },
  {
    pattern: /class="[^"]*\bportal-col--content\b[^"]*"/i,
    message: "Portal is missing the content column wrapper.",
  },
  {
